...
class HomeScreen(Screen):
    """
    The screen which greets the user on application startup.

    Allows the user to navigate to other screens.
    """
    ...
    def create_gui(self):
        ...
        # Delete back button from home screen (it is the only screen without it).
        ...
        # Create button to navigate to chat screen.
